...
from src.config import create_notification_service, setup_logging
...
Команда организаторов
        ...
        for i, (user, report) in enumerate(zip(users, bulk_reports, strict=False), 1):
            ...
            if report.success:
                ...
                print("   Ошибка: Недоступны каналы связи")
